...
export type Statement = ExpressionStatement | Var | Const | TypeAlias
...
export type Declaration = Var | Const | TypeAlias // plus others, like function
export type Symbol = {
